...
const Nasabah = () =>{
    ...
    useEffect(() =>{
        const fetchAllSentra = async ()=>{
            try {
                const resPriode = await axios.get("https://sihpn-server-final-production.up.railway.app/admin/nasabah/priode", {withCredentials: true})
    ...
    const handleDelete = async (id) =>{
        try {
            await axios.delete("https://sihpn-server-final-production.up.railway.app/admin/nasabah/"+id, {withCredentials: true})
            await axios.delete("https://sihpn-server-final-production.up.railway.app/admin/hadiah/"+id, {withCredentials: true})
    ...
    const handleMove = async (e) =>{
        try{
            const res = await axios.get("https://sihpn-server-final-production.up.railway.app/admin/nasabah/" + cosedPriode.priode, {withCredentials: true})
            setNasabah(res.data);
        }catch (err) {
            console.log(err)
        }
