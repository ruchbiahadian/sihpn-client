...
const HadiahNasabah = () =>{
    ...
    useEffect(() =>{
        const fetchAllSentra = async ()=>{
            try {
                const res = await axios.get("http://localhost:8800/admin/nasabah/hadiah/" + userId, {withCredentials: true})
                ...
                const res2 = await axios.get("http://localhost:8800/admin/daftar-hadiah/" + nasabahPoin, {withCredentials: true})
